...
const faqs = [
  { q: "¿Cómo entro al servidor?", a: "Abre Minecraft, ve a Multijugador y agrega la IP: play.solvianmc.net con el puerto: 25565" },
...
const copyIP = () => {
  ...
  toast.success("¡IP copiada!", { description: "IP: play.solvianmc.net — Puerto: 25565" });
};
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4">
          ...
          <div className="mt-6 flex flex-col items-center gap-1">
            ...
            <span className="text-background/60 text-xs font-body">Puerto: 25565</span>
          </div>
        </div>
      </section>
